      ...
      <div className='w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4'>
        ...
        <div className='w-full'>
          <select 
            ...
            className="w-full border-b-2 border-gray-200 rounded-md text-base outline-none cursor-pointer p-2"
          >
        ...
        <div className="w-full flex flex-col md:flex-row items-center gap-3">
          <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
            ...
            <input 
              ...
              className="w-full h-full outline-none bg-transparent border-none placeholder:text-gray-400 text-textColor" 
            />
          </div>
        ...
        <div className='w-full flex items-center'>
          <button type='button' className='ml-0 md:ml-auto w-full md:w-auto border-none outline-none bg-emerald-500 px-12 py-2 rounded-lg text-white text-lg font-semibold' onClick={saveDetails}>Save Item</button>
        </div>
      </div>
    </div>
  )
